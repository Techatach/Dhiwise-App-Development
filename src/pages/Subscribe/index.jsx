...
const SubscribePage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-inter gap-[50px] items-center justify-start mx-auto w-full my-8">
        ...
        <div className="flex flex-col items-center justify-start w-full">
          <div className="flex flex-col gap-10 items-center justify-start max-w-[944px] mx-auto md:px-5 w-full">
            ...
            <Text
              className="leading-[35.00px] text-black-900_7f text-center text-xl tracking-[-0.50px] w-full"
              size="txtInterRegular18Black9007f"
            >
              <>
                การเรียนการสอนในหลักสูตรรัฐประศานศาสตร์
                จะต้องเรียนบูรณาการกับเทคโนโลยีอัจฉริยะและเทคโนโลยีดิจิทัล Lorem
